            ...
            $("#CatalogID").select2({               
                ajax:{
                    ...
                    // Clear drop down list           
                        options = $('[name="CatalogID"]');
                        options.empty();
                        $.each(data, function () {
                            //console.log(this.CatalogID);                        
                            var obj = [{ id: this.catalogID, text: this.catalogName }]      
                ...
                columns: [
                    ...
                    { "data": "modifiedDate" },
                    {
                        ...
                        "mRender": function (data, type, full) {
                            return "<button type='button' class='btn btn-rounded btn-outline btn-info' href='javascript:void(0)' title='Edit' onclick='ExportView.voidEdit(" + '"' + data.categoryID + '"' + ")'><i class='fa fa-pencil'></i></button>"
                                + "<button type='button' class='btn btn-rounded btn-outline btn-danger' href='javascript:void(0)' title='Delete' onclick='ExportView.voidRemoveById(" + '"' + data.categoryID + '"' + ")'><i class='fa fa-trash'></i></button>";
                        }
                    }
                ],
                buttons: [{
